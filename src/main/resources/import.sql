INSERT INTO prodotto(prezzo,  descrizione, foto, nome)VALUES(7,  ' Le tazze da museo sono prodotti che rappresentano o celebrano opere d arte. Le tazze sono realizzate con materiali di alta qualità come ceramica o porcellana. Immagini sulle tazze sono stampati con cura per garantire una riproduzione fedele dell opera.', '/tazza-museo.png', 'Tazze');
INSERT INTO prodotto(prezzo,  descrizione, foto, nome)VALUES(20,  'Benvenuto nella nostra sezione libri, un tesoro di conoscenza che ti accompagna in un viaggio attraverso le epoche e le culture. Scegli tra una varietà di opere che si fondono armoniosamente con la vastità e la diversità delle nostre collezioni. ', 'https://i.pinimg.com/originals/97/bd/c4/97bdc4bdda3c33e762a96637db28b61c.jpg', 'Libri');
...
INSERT INTO prodotto(prezzo,  descrizione, foto, nome)VALUES(25,  'Un set completo di gioielli che fondono design contemporaneo con lusso senza tempo. Ogni pezzo è caratterizzato da linee pulite e materiali di alta qualità, creando un insieme armonioso che si adatta ad ogni occasione.', '/gioielli-arte.png', 'Gioielli');
INSERT INTO prodotto(prezzo, descrizione, foto, nome)VALUES(15,  'Immergiti in un\'avventura unica nel suo genere con il nostro puzzle "Viaggio nel Tempo". Questo puzzle è progettato per portarti attraverso le epoche storiche e ti sfiderà a collegare i pezzi del passato in un affascinante mosaico di conoscenza.', '/puzzle-arte.png', 'Puzzle');
