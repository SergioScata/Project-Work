...
INSERT INTO assortimento(data_assortimento, nome, nome_fornitore, prezzo_singolo, quantita_acquistata, prodotto_id)VALUES('2024-01-28', 'Puzzle a tema', 'jewerly industries', 3, 400, 6);
INSERT INTO assortimento(data_assortimento, nome, nome_fornitore, prezzo_singolo, quantita_acquistata, prodotto_id)VALUES('2024-01-28', 'Cartoline', 'libreria antica ', 1, 300, 7);
INSERT INTO assortimento(data_assortimento, nome, nome_fornitore, prezzo_singolo, quantita_acquistata, prodotto_id)VALUES('2024-01-28', 'Modelli archittetonici', 'Ceramic industries', 22, 300, 8);
INSERT INTO assortimento(data_assortimento, nome, nome_fornitore, prezzo_singolo, quantita_acquistata, prodotto_id)VALUES('2024-01-28', 'Vaso antico', 'Ceramic industries', 34, 250, 9);
INSERT INTO assortimento(data_assortimento, nome, nome_fornitore, prezzo_singolo, quantita_acquistata, prodotto_id)VALUES('2024-01-28', 'Tela d\'arte moderna  ',' libreria antica', 89, 100, 5);
INSERT INTO acquisto(codice, data_acquisto, nome, prezzo_singolo, quantita, prodotto_id, user_id)VALUES(234535, '2024-01-21', 'Repliche statue', 30, 10, 1, 1);
INSERT INTO acquisto(codice, data_acquisto, nome, prezzo_singolo, quantita, prodotto_id, user_id)VALUES(236535, '2024-01-23', 'Repliche statue', 30, 50, 1, 3);
INSERT INTO acquisto(codice, data_acquisto, nome, prezzo_singolo, quantita, prodotto_id, user_id)VALUES(237835, '2024-01-25', 'Libri di Storia e Epica', 20, 200, 2, 2);
INSERT INTO acquisto(codice, data_acquisto, nome, prezzo_singolo, quantita, prodotto_id, user_id)VALUES(233235, '2024-01-29', 'Tela d\'arte moderna ', 180, 32, 5, 3);
INSERT INTO assortimento(data_assortimento, nome, nome_fornitore, prezzo_singolo, quantita_acquistata, prodotto_id)VALUES('2024-01-28', 'Libri di Storia e Epica', 'libreria antica', 89, 200,2);
